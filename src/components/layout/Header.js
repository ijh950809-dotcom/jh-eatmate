...
const Header = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/user/${token_no}`)
        ...
        <div className='user-box'>
          {
            ...
            <div className="img-box">
              <img
                src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/user/${user.u_pic}?t=${Date.now()}`}
                alt="프로필"
              />
            </div>
          }
