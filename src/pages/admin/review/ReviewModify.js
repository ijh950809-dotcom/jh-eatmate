...
function ReviewCreate(props) {
  ...
  useEffect(() => {
    axios.get(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/review/${br_no}`)
      .then(res => {
        setReviewData(prev => ({
          ...prev,
  ...
  const handleChange = (e) => {
    ...
    if (name === 'rt_no') {
      const rt_no = value;
      axios.get(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/restaurant/${rt_no}`)
        .then(res => {
          setReviewData(prev => ({
            ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/review', formData);
