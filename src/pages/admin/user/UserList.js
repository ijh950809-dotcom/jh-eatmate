...
function UserList(props) {
  ...
  const loadData = () => {
    axios.get('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/user')
      .then(res => {
        setData(res.data);
      })
  ...
  const delData = (u_no) => {
    if (window.confirm('삭제하시겠습니까?')) {
      axios
        .delete(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/user/${u_no}`)
        .then(() => {
          alert('삭제되었습니다.')
          loadData();
        })
