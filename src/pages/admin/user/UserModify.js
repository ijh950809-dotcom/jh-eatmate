...
function UserCreate(props) {
  ...
  // 기본 유저기본값 나오게
  useEffect(() => {
    axios.get(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/mypage/${u_no}`)
      .then(res => {
        setUserModify(prev => ({
          ...prev,
          u_id: res.data.u_id || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/mypage/profile/modify/${u_no}`, formData);
