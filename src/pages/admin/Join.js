...
const Join = () => {
  ...
  // 아이디 중복 체크
  const idCheck = () => {
    axios.post('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/idcheck', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/admin/join', formData);
