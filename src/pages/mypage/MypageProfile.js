...
const MypageProfile = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/mypage/${user_no}`)
      .then(res => {
  ...
  const nickCheck = async () => {
    try {
      const res = await axios.post('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/nickcheck', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/mypage/profile/modify/', formData);
