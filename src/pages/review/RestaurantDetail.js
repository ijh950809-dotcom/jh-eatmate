...
const RestaurantDetail = () => {
  ...
  const bookmarkClick = async () => {
    ...
    try {
      await axios.post('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/bookmark', info);
  ...
  const rtLoadData = async () => {
    try {
      const res = await axios.get(`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/restaurant/detail/${rt_no}`);
  ...
  const rvLoadData = async () => {
    try {
      const res = await axios.get('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/review', {
        params: { rt_no },
      });
  ...
  useEffect(() => {
    ...
    const loadBookmark = async () => {
      ...
      try {
        const res = await axios.get('https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/bookmark/check', {
            ...
            >
              {
                ...
                <SwiperSlide>
                  <div className="img-box">
                    <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/restaurant/${restaurantData.rt_img}`} alt={`${restaurantData.rt_name} 메인`} />
                  </div>
                </SwiperSlide>
              }
              {
                ...
                <SwiperSlide>
                  <div className="img-box">
                    <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/restaurant/${restaurantData.rt_img2}`} alt={`${restaurantData.rt_name} 메인`} />
                  </div>
                </SwiperSlide>
              }
              {
                ...
                <SwiperSlide>
                  <div className="img-box">
                    <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/restaurant/${restaurantData.rt_img3}`} alt={`${restaurantData.rt_name} 메인`} />
                  </div>
                </SwiperSlide>
              }
              {
                ...
                <SwiperSlide>
                  <div className="img-box">
                    <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/restaurant/${restaurantData.rt_img4}`} alt={`${restaurantData.rt_name} 메인`} />
                  </div>
                </SwiperSlide>
              }
              {
                ...
                <SwiperSlide>
                  <div className="img-box">
                    <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/restaurant/${restaurantData.rt_img5}`} alt={`${restaurantData.rt_name} 메인`} />
                  </div>
                </SwiperSlide>
              }
            </Swiper>
                ...
                reviewData.map(item => (
                  <li key={item.br_no}>
                    <Link to={`/review/detail/${item.br_no}`} title={`${item.rt_name} 리뷰 상세 페이지로 이동`}>
                      <div className="img-box">
                        <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/review/${item.br_img}`} alt={`${item.rt_name} 리뷰`} />
                      </div>
