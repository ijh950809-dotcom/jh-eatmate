          ...
          <div className="image-area">
            {
              reviewData.br_img &&
              <div className="img-box">
                <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/review/${reviewData.br_img}`} alt={`${reviewData.rt_name} 대표`} />
              </div>
            }
            {
              reviewData.br_img2 &&
              <div className="img-box">
                <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/review/${reviewData.br_img2}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
            {
              reviewData.br_img3 &&
              <div className="img-box">
                <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/review/${reviewData.br_img3}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
            {
              reviewData.br_img4 &&
              <div className="img-box">
                <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/review/${reviewData.br_img4}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
            {
              reviewData.br_img5 &&
              <div className="img-box">
                <img src={`https://port-0-jh-eatmate-backend-mleqh0x837c33d90.sel3.cloudtype.app/uploads/review/${reviewData.br_img5}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
          </div>
